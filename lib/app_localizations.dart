...
final Map<String, Map<AppLanguage, String>> _translations = {
  ...
  'common.invalidUrl': {
    AppLanguage.zhHant: '網址無效',
    AppLanguage.zhHans: '网址无效',
    AppLanguage.en: 'Invalid URL',
  },
  'common.unknown': {
  ...
  'home.quick.favorites': {
    AppLanguage.zhHant: '我的收藏',
    AppLanguage.zhHans: '我的收藏',
    AppLanguage.en: 'Favorites',
  },
  'home.quick.downloads': {
    AppLanguage.zhHant: '下載清單',
    AppLanguage.zhHans: '下载清单',
    AppLanguage.en: 'Downloads',
  },
  'home.quick.addDownload': {
    AppLanguage.zhHant: '新增下載',
    AppLanguage.zhHans: '新增下载',
    AppLanguage.en: 'Add download',
  },
  'home.quick.media': {
    AppLanguage.zhHant: '媒體櫃',
    AppLanguage.zhHans: '媒体库',
    AppLanguage.en: 'Library',
  },
  'home.quick.tabs': {
    AppLanguage.zhHant: '分頁',
    AppLanguage.zhHans: '分页',
    AppLanguage.en: 'Tabs',
  },
  'home.quick.history': {
    AppLanguage.zhHant: '歷史紀錄',
    AppLanguage.zhHans: '历史记录',
    AppLanguage.en: 'History',
  },
  'home.quick.clearCache': {
    AppLanguage.zhHant: '清除緩存',
    AppLanguage.zhHans: '清除缓存',
    AppLanguage.en: 'Clear cache',
  },
  'home.emptyState': {
  ...
  'settings.detectMediaLongPress.title': {
    AppLanguage.zhHant: '自動偵測媒體',
    AppLanguage.zhHans: '自动侦测媒体',
    AppLanguage.en: 'Auto-detect media',
  },
  'settings.detectMediaLongPress.subtitle': {
    AppLanguage.zhHant: '自動將正在播放的影片加入「播放中」列表',
    AppLanguage.zhHans: '自动将正在播放的视频加入“播放中”列表',
    AppLanguage.en:
        'Automatically add playing videos to the Now Playing panel.',
  },
  'settings.detectMediaLongPress.snack.enabled': {
    AppLanguage.zhHant: '已開啟自動偵測媒體',
    AppLanguage.zhHans: '已开启自动侦测媒体',
    AppLanguage.en: 'Media auto-detection enabled.',
  },
  'settings.detectMediaLongPress.snack.disabled': {
    AppLanguage.zhHant: '已關閉自動偵測媒體',
  ...
  'media.dialog.deleteItem.title': {
    AppLanguage.zhHant: '刪除檔案',
    AppLanguage.zhHans: '删除文件',
    AppLanguage.en: 'Delete file',
  },
  'media.dialog.deleteItem.message': {
    AppLanguage.zhHant: '確定要刪除「{name}」嗎？',
    AppLanguage.zhHans: '确定要删除「{name}」吗？',
  ...
  'browser.youtube.option.type.hls': {
    AppLanguage.zhHant: 'HLS（原生下載）',
    AppLanguage.zhHans: 'HLS（原生下载）',
    AppLanguage.en: 'HLS (native download)',
  },
  ...
  'browser.youtube.option.hlsHint': {
    AppLanguage.zhHant: '使用 iOS 原生離線下載，較穩定',
    AppLanguage.zhHans: '使用 iOS 原生离线下载，更稳定',
    AppLanguage.en: 'Uses iOS native offline download, more reliable',
  },
  ...
  'browser.playingNow.button': {
    AppLanguage.zhHant: '播放中({count})',
    AppLanguage.zhHans: '播放中({count})',
    AppLanguage.en: 'Now playing ({count})',
  },
  'browser.playingNow.action.stream': {
    AppLanguage.zhHant: '串流',
    AppLanguage.zhHans: '串流',
    AppLanguage.en: 'Stream',
  },
  ...
  'browser.dialog.addDownload.title': {
    AppLanguage.zhHant: '新增下載',
    AppLanguage.zhHans: '新增下载',
    AppLanguage.en: 'Add download',
  },
  ...
  'download.notification.failed.title': {
    AppLanguage.zhHant: '下載失敗',
    AppLanguage.zhHans: '下载失败',
    AppLanguage.en: 'Download failed',
  },
  'download.notification.failed.body': {
    AppLanguage.zhHant: '{name} 下載失敗。',
    AppLanguage.zhHans: '{name} 下载失败。',
    AppLanguage.en: '“{name}” failed to download.',
  },
  ...
  'download.live.subtitle.group': {
    AppLanguage.zhHant: '{count} 個下載',
    AppLanguage.zhHans: '{count} 个下载',
    AppLanguage.en: '{count} downloads',
  },
  'download.live.subtitle.background': {
    AppLanguage.zhHant: '背景下載中',
    AppLanguage.zhHans: '后台下载中',
    AppLanguage.en: 'Downloading in background',
  },
