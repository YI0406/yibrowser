...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(
    ...
    LiveActivityManager.shared.configure(messenger: flutterVC.binaryMessenger)
    IosHlsDownloader.shared.configure(messenger: flutterVC.binaryMessenger)
    if let appDelegate = UIApplication.shared.delegate as? AppDelegate {
      appDelegate.configureDeepLinkChannel(messenger: flutterVC.binaryMessenger)
      appDelegate.configureNativeNotificationChannel(messenger: flutterVC.binaryMessenger)
      appDelegate.configureShareBridgeChannel(messenger: flutterVC.binaryMessenger)
    }
